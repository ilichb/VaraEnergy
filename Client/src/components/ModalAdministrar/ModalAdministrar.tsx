          ...
          <div>
            <div className="w-[320px] h-full rounded flex flex-col">
              <div className="flex flex-col items-center">           
                <button onClick={() => {setShowConfig(true)}} className="w-[250px] h-[30px] bg-[#74C7ED] rounded-[5px] text-md text-[#ffffff] mt-4" >
                  Configuracion del sistema
                </button>
                
                <button onClick={() => {setShowManten(true)}} className="w-[250px] h-[30px] bg-[#74C7ED] rounded-[5px] text-md text-[#ffffff] mt-4" >
