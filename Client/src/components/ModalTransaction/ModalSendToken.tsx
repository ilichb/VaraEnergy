...
const ModalSendToken = () => {
  ...
  return (
    <div className="fixed bg-black/70 top-0 left-0 w-full h-full flex items-center justify-center">
      <div className="bg-secondary rounded-3xl relative w-2/6 h-1/2 flex flex-col items-center justify-between">
        <div className="flex justify-end w-full">
          <button className="text-xl text-red-500 p-2.5">
            <svg
              width="20"
              height="23"
              viewBox="0 0 20 23"
